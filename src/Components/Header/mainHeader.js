...
const Header = () => (
  ...
  <Link className="link menu   dark-gray tc tr-ns tl-ns f3 f5-ns  pv1 mr0 " to="/" title="Home">Home</Link>
  ...
  <Link to="/" className="w-15  mt3 hmb fr tr v-mid  p0-ns link dim dark-gray">
    ...
    <div className="  dn-l   ">
    <Link className="link   dark-gray   tl-ns  f5-ns  pv1 mr0 mr4-ns" to="/" title="Home">Home</Link>
    ...
    <Link className="link   dark-gray  tl-ns  f5-ns  pv1 mr0 mr1-ns" to="/logOut" title="logOut">Log Out</Link>
