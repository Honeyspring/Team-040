...
handleChoice(event){
  ...
  render(){
    ...
    <div className=" w-100 w-100 w-100-l">
      ...
      <img src={apc} className=" br-100 ba  bg-color  ma4 mw  b--black-10 mv4 w-25   shadow-5  "  onClick={this.open}/>

        <img src={pdp} className="br-100  ba  bg-color ma4  mw  b--black-10 mv4 w-25   shadow-5  " onClick={this.open}/>

      <img src={apc} className=" br-100 ba  bg-color ma4  mw  b--black-10 mv4 w-25   shadow-5  "  onClick={this.open}/>

        <img src={ann} className="br-100  ba  bg-color ma4  mw  b--black-10 mv4 w-25   shadow-5  " onClick={this.open} />

        <img src={accord} className="br-100  ba  bg-color ma4  mw  b--black-10 mv4 w-25   shadow-5  " onClick={this.open} />

        <img src={sdp} className="br-100  ba  bg-color ma4  mw  b--black-10 mv4 w-25   shadow-5  " onClick={this.open}/>
